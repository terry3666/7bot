...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EsaywqxxIYy2EzY2JGh8.NyA+PG8TJV88Pn6FcTZmsa.mPjPc1shxCNmWV50X9aEn56hsaUy4k4fugN1Tmwioik=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EsVeQ57UAxwm84vL75u6.KmPykel90yCItZ1HUpdRPG.VdfN23DfBWGrCbVXe7Jb/ixTIyglVS3dQmLhvtmRCPY=")
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="EsVgKFIqwI8cug0NrDOe.cfU11NWrEakjPSDwvX5qpG.MkrM9Vjy5enpQPF7RzuwdU8VzkWwolDxFtCXO8RDWAs=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="EsinPQbR9Ne81tSLcnoa.IYbKi80JSiOSiZ8cwc/CIG.lTf58maQBUIOlMa2Ve39BKVDWqAVEHIpyp1f7rR6h5c=")
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="Esq81auxpyZBHwoN7Wr6.za+e5svtVOOkvtLheQuILG.GdHffxfl12tMfKsTMAwbWJEm6zJmn561N82q5CUOibM=")
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token="EsxzXL72nwCaNFlmkNy9.z6Y7Pa9DEyo9ymia6srw6q.5UoISY7ZMLo9HPkDJ9V2HEfJl9Br0uGfcMxMjjlCk4c=")
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token="EsMeIOJ4X6Ef7DSN41k0.iBuGmRcpaRydqClemgvK8a.DVdrvqSgIg54AkiFpQl6kZ8LZza5MPA3fpK9aP0LQHM=")
km.loginResult()
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : ρнαитσм gнσѕт\nContact Me : (ghost)  line.me/ti/p/~rian-rian.",
    "comment2":"Auto Like ©By : ρнαитσм gнσѕт\nContact Me : (ghost) line.me/ti/p/~rian-rian.",
    "comment3":"Auto Like ©By : ρнαитσм gнσѕт\nContact Me : (ghost) line.me/ti/p/~rian-rian.",
    "comment4":"Auto Like ©By : ρнαитσм gнσѕт\nContact Me : (ghost) line.me/ti/p/~rian-rian.",
    "comment5":"Auto Like ©By : ρнαитσм gнσѕт\nContact Me : (ghost) line.me/ti/p/~rian-rian.",    
    "commentOn":True,
    "commentBlack":{},
...
def bot(op):
    try:
	    ...
	    if mid in op.param3:
			...
			cl.cancelGroupInvitation(op.param1, [op.param3])
			cl.sendText(op.param1, "maaf dia ada di daftar hitam")
		    else:
			pass
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            cl.sendMessage(c)
            cl.sendText(op.param1,"Hallo " + cl.getContact(op.param2).displayName + "\nSelama datang di  ☞ " + str(ginfo.name) + " ☜" + "\nsalam kenal ya ^_^")
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Tuh owner ρнαитσм gнσѕт yg paling pea (^_^)")
               ...
               # admin1 = "uda936836a9869eb86ec8ab992a4e8979"
                ...
                #random.choice(KAC).sendMessage(msg)                
		random.choice(KAC).sendText(msg.to,"admin ρнαитσм gнσѕт yg dudul (^_^)")	
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus ρнαитσм gнσѕт")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Admin ρнαитσм gнσѕт")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"Bot Di Paksa Keluar Oleh Owner ρнαитσм gнσѕт")
		            cl.leaveGroup(i)
			    ki.leaveGroup(i)
			    kk.leaveGroup(i)
			    kc.leaveGroup(i)
...
#		else:                    
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["bot","phantom"]:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u67acbba40f5d7983bd60c200e92456e9"}
                cl.sendMessage(msg)
